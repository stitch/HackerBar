...
class DB {
  // initial connection
  public static $dbName = 'hackerbarlivedump'; //hackerbarlivedump (a dump from live) or hackerbar (for dev)
  public static $user = 'root'; // baruser
  public static $password = ''; // 209ewVdjiwjdoq
  public static $host = 'localhost';
  public static $port = null;
  public static $encoding = 'latin1'; // should be utf // stitch
